...
- Name: 11-typography-tools.spec.js >> Font Gallery >> the detail dialog is closable from the keyboard and restores focus
- Location: tests\user-sim\11-typography-tools.spec.js:500:3
