...
- Name: 10-home-chaos-to-calm.spec.js >> homepage: eleven tools, five ways of working >> 11c · a direct visit and a manual upload never move the viewport
- Location: tests\user-sim\10-home-chaos-to-calm.spec.js:1459:3

# Error details

```
Error: /create/file-converter: the route never got past its lazy-loading fallback in 20000ms — mounted=false fallback=false bodyChars=0 ownChars=0
```
