...
- Name: 11-typography-tools.spec.js >> Font Gallery >> a full-width row spends its width on the typeface, not on empty space
- Location: tests\user-sim\11-typography-tools.spec.js:539:3
