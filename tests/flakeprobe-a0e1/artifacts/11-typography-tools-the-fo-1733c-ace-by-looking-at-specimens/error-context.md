...
- Name: 11-typography-tools.spec.js >> the font picker is browsable >> a designer picks a heading face by looking at specimens
- Location: tests\user-sim\11-typography-tools.spec.js:861:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4512/fontpairs
Call log:
  - navigating to "http://127.0.0.1:4512/fontpairs", waiting until "domcontentloaded"
