...
- Name: 11-typography-tools.spec.js >> Font Gallery >> without document.fonts a settled stylesheet still needs canvas proof and can retry
- Location: tests\user-sim\11-typography-tools.spec.js:692:3
