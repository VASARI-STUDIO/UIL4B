...
- Name: 11-typography-tools.spec.js >> typography tools under a failing font catalogue >> going offline is reported without losing the workbench
- Location: tests\user-sim\11-typography-tools.spec.js:834:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4512/create/type-scale
Call log:
  - navigating to "http://127.0.0.1:4512/create/type-scale", waiting until "domcontentloaded"
