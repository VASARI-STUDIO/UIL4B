...
- Name: 11-typography-tools.spec.js >> typography tools under a failing font catalogue >> a blocked catalogue degrades visibly and still lets the tools work
- Location: tests\user-sim\11-typography-tools.spec.js:818:3
