...
- Name: 11-typography-tools.spec.js >> Font Gallery >> code, emoji, icon and symbol families never enter the gallery
- Location: tests\user-sim\11-typography-tools.spec.js:298:3

# Error details

```
Error: /create/font-gallery: the route never got past its lazy-loading fallback in 20000ms — mounted=false fallback=false bodyChars=0 ownChars=0
```
