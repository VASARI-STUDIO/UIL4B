...
- Name: 11-typography-tools.spec.js >> the font picker is browsable >> the trigger shows the current family in that family
- Location: tests\user-sim\11-typography-tools.spec.js:907:3
