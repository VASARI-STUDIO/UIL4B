...
- Name: 11-typography-tools.spec.js >> Font Gallery >> rows reserve their metrics so the list never reflows as faces load
- Location: tests\user-sim\11-typography-tools.spec.js:515:3
