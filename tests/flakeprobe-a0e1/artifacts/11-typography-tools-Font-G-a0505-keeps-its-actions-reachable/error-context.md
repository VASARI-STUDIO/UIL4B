...
- Name: 11-typography-tools.spec.js >> Font Gallery >> the specimen dialog fits the viewport and keeps its actions reachable
- Location: tests\user-sim\11-typography-tools.spec.js:423:3
