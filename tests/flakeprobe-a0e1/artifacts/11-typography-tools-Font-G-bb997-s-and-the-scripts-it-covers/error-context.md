...
- Name: 11-typography-tools.spec.js >> Font Gallery >> the specimen dialog shows every real weight as words, and the scripts it covers
- Location: tests\user-sim\11-typography-tools.spec.js:459:3
