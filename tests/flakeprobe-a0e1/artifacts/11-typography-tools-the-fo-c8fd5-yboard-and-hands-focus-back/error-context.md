...
- Name: 11-typography-tools.spec.js >> the font picker is browsable >> the browser closes from the keyboard and hands focus back
- Location: tests\user-sim\11-typography-tools.spec.js:892:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4512/typescale
Call log:
  - navigating to "http://127.0.0.1:4512/typescale", waiting until "domcontentloaded"
