...
- Name: 11-typography-tools.spec.js >> Font Gallery >> a blocked stylesheet reports fallback and a successful retry clears the failure
- Location: tests\user-sim\11-typography-tools.spec.js:638:3
