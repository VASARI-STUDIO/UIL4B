...
Always `Read` `CLAUDE.md` and `docs/PRODUCT-AUDIT-2026-06-16.md` at the start of a task for the current state of the app, and `Read` `src/styles/global.css` for the live tokens before you spec anything.
