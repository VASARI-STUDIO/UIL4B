...
export const PAGE_DESCRIPTIONS = {
  ...
  '/discover/resources': 'Hand-picked design and development tools from across the web — gradients, palettes, fonts, components and free assets — each with the reason it earned a tab and a route into the UI L4B tool that finishes the job.',
