...
export const TOOLS = [
  ...
  { id: 'fontgallery', label: 'Font Gallery', path: '/fontgallery', category: 'typography', description: 'Visual gallery to browse and preview typefaces.', keywords: ['font', 'gallery', 'browse', 'typeface', 'preview', 'google fonts'] },
