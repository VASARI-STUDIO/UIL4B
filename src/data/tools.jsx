...
export const TOOLS = [
  ...
  { id: 'seo', label: 'SEO Inspector', path: '/seo', category: 'documentation', subcategory: 'Marketing & SEO', description: 'Live Google snippet + social card preview with an instant, scored SEO checklist.', keywords: ['seo', 'meta', 'serp', 'title', 'description', 'snippet', 'preview', 'open graph', 'social', 'score', 'inspector', 'specialist'], icon: (<><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></>) },
