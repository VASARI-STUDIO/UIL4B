...
export const TOOLS = [
  ...
  { id: 'design-reference', label: 'Design Reference', path: '/design-reference', category: 'documentation', description: 'Spacing, shadows, radii, font scales, and design token reference.', keywords: ['tailwind', 'spacing', 'shadow', 'radius', 'tokens', 'reference', 'cheat sheet'], icon: (<><path d="M4 4h16v16H4z"/><path d="M4 9h16"/><path d="M9 9v11"/><path d="M7 6.5h1"/></>) },
