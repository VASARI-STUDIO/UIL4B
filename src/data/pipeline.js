...
export const NEXT_TODO = [
  ...
  // Reported by the founder in conversation with the Director. Every item in
  // this block is OBSERVED ONLY: it is the founder's description of what he
  // saw, and none of it has been reproduced by an engineer, isolated to a
  // cause, or pinned by a failing test yet. Reproduce first, then fix — do not
  // treat the description as a diagnosis. Recorded 2026-08-08.
  { id: 'palette-temperature-snap', title: 'Fix the Temperature slider glitch when it snaps back to 0', priority: 'P1', effort: 'S', area: 'Colour', status: 'todo', note: 'Observed (founder report, not reproduced): in the Palette Builder the Temperature slider glitches when it snaps back to 0 part-way along the track.' },
  ...
  { id: 'fontpair-panel-viewport-fit', title: 'Keep the Font Pair "Choose the pair" panel inside the viewport', priority: 'P1', effort: 'S', area: 'Typography', status: 'todo', note: 'Observed (founder report, not reproduced): the "Choose the pair" panel overflows the viewport. It should always fit on screen — check the affected widths before choosing between a scroll container, a reflow and a size change.' },
  ...
  { id: 'auth-modal-close-navigates-home', title: 'Closing the "Start for Free" popup should dismiss it, not navigate home', priority: 'P1', effort: 'S', area: 'Account', status: 'todo', note: 'Observed (founder report, not reproduced): in the Palette Library, "Start for Free" opens a popup; dismissing it with the X sends the user to the home page instead of closing the popup and leaving them where they were. Touches auth surfaces — check docs/reference/human-validation-zones.md before editing.' },
  ...
  { id: 'colour-role-names-by-system', title: 'Name colour roles to suit the active colour system', priority: 'P1', effort: 'M', area: 'Colour', status: 'todo', note: 'Observed (founder report, not reproduced): role labels (Accent, Subtle, Deep…) are fixed, so on Monochromatic the swatch labelled "Accent" reads as a subtle tone. The label set should follow the selected colour system.' },
  ...
  { id: 'font-gallery-ui', title: 'Improve the Font Gallery UI', priority: 'P1', effort: 'M', area: 'Typography', status: 'todo', note: 'Founder request (2026-08-08), stated at that level of detail. Diagnose the specific failures on the rendered surface before proposing a direction.' },
  { id: 'fontpair-browsable-selection', title: 'Make Font Pair selection browsable instead of recall-and-type', priority: 'P1', effort: 'M', area: 'Typography', status: 'todo', note: 'Observed (founder report, not reproduced): choosing a pair expects the user to remember and type font names. Selection should be visual and browsable.' },
  { id: 'fonts-in-use-surface', title: 'Build a "fonts in use" surface', priority: 'P2', effort: 'L', area: 'Typography', status: 'blocked', note: 'Founder request (2026-08-08): a surface showing how real brands use type in the wild (reference: fontsinuse.com). BLOCKED — content sourcing is unresolved (rights, provenance and who curates). Do not start the build until that is answered.' },
