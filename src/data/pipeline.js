...
export const NEXT_TODO = [
  ...
  { id: 'library-ui-language', title: 'Extend the gradient/palette library UI language to the other browsing surfaces', priority: 'P1', effort: 'L', area: 'Design system', status: 'todo', note: 'Founder direction 2026-08-15: "i want the UI for alot of pages to take influence from the UI in the gradient and pallete libraries". Treat the two libraries as the reference implementation of browsing in this product and extract what actually makes them work (card rhythm, filtering, hover/preview affordance, density) into something reusable, rather than copying their CSS per page. Consumers named by the founder in the same breath: the font gallery (font-gallery-ui), font pair selection (fontpair-browsable-selection) and the Discover galleries (discover-galleries). Do the extraction before the individual redesigns or the same decisions get made three times and drift.' },
