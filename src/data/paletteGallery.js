...
export const GALLERY_PALETTES = [
  ...
  //
  // `added` is the date this wave reached the library, read off `git blame`.
  // The first 32 carry no date on purpose — they are the original set and
  // nothing is newer than an
  // entry that has one. The workspace's "New in Discover" sorts by it
  // (components/userhome/DiscoverPicks.jsx); a palette added later should
  // carry its own date the same way rather than be picked by position.
  { id: 'concrete-chartreuse', name: 'Concrete & Chartreuse', colors: ['#E8E8E4', '#B4B4AC', '#4E504F', '#C8D92E'], added: '2026-08-06' },
  { id: 'safety-signal', name: 'Safety Signal', colors: ['#111111', '#2B2B2B', '#FFD100', '#FF6B00'], added: '2026-08-06' },
  { id: 'cyber-neon', name: 'Cyber Neon', colors: ['#07060E', '#1B0F3B', '#FF00A8', '#00F0FF'], added: '2026-08-06' },
  { id: 'burgundy-brass', name: 'Burgundy & Brass', colors: ['#2B0A12', '#5C1229', '#B08D57', '#F2E4D0'], added: '2026-08-06' },
  { id: 'sage-charcoal', name: 'Sage & Charcoal', colors: ['#2F3330', '#5C6B5D', '#A8BFA3', '#EDF1E8'], added: '2026-08-06' },
  { id: 'newsprint', name: 'Newsprint', colors: ['#F4F1EA', '#D9D3C7', '#1A1A18', '#C6291E'], added: '2026-08-06' },
  { id: 'mango-tango', name: 'Mango Tango', colors: ['#FFF3D6', '#FFC24B', '#FF7A00', '#B33F00'], added: '2026-08-06' },
  { id: 'rainforest-canopy', name: 'Rainforest Canopy', colors: ['#04170F', '#0E3B24', '#2E7D53', '#9FE0A8'], added: '2026-08-06' },
  { id: 'deep-space-gold', name: 'Deep Space Gold', colors: ['#080B1A', '#141B3D', '#3B4A8C', '#E8C36B'], added: '2026-08-06' },
  { id: 'clinic-mint', name: 'Clinic Mint', colors: ['#FFFFFF', '#EAF7F2', '#3FD0A8', '#0B3B34'], added: '2026-08-06' },
  { id: 'dusty-mauve', name: 'Dusty Mauve', colors: ['#241A26', '#4B3A50', '#9E7E9B', '#E4D3DF'], added: '2026-08-06' },
  { id: 'maple-fall', name: 'Maple Fall', colors: ['#FBF1E3', '#E0A458', '#C1462A', '#5A2B1D'], added: '2026-08-06' },
  { id: 'pine-frost', name: 'Pine Frost', colors: ['#0C1B18', '#16382F', '#5E9C86', '#D7E8DE'], added: '2026-08-06' },
  { id: 'terminal-lime', name: 'Terminal Lime', colors: ['#0D0F0C', '#1A1F17', '#7BE04E', '#D6F5C4'], added: '2026-08-06' },
  { id: 'rose-gold', name: 'Rose Gold', colors: ['#FDF1EE', '#F0C9BF', '#C98878', '#7A4A3E'], added: '2026-08-06' },
  { id: 'bubblegum-sky', name: 'Bubblegum Sky', colors: ['#FFEAF4', '#FFA8D2', '#7ACDF5', '#2A6FA8'], added: '2026-08-06' },
  { id: 'ash-lava', name: 'Ash & Lava', colors: ['#111013', '#3A3438', '#8C8288', '#E23E24'], added: '2026-08-06' },
  { id: 'wine-ivy', name: 'Wine & Ivy', colors: ['#1A0E14', '#4A1028', '#2F5D3A', '#E7DCCB'], added: '2026-08-06' },
  { id: 'indigo-saffron', name: 'Indigo & Saffron', colors: ['#101A4A', '#2B3A93', '#E8843B', '#F6E3C0'], added: '2026-08-06' },
  { id: 'riverbed', name: 'Riverbed', colors: ['#E9EEEC', '#B7C6C2', '#6F8A87', '#33474A'], added: '2026-08-06' },
  { id: 'flamingo-dusk', name: 'Flamingo Dusk', colors: ['#4A1F44', '#8E3A6B', '#E8688C', '#FFC4B4'], added: '2026-08-06' },
  { id: 'copper-slate', name: 'Copper & Slate', colors: ['#1C2126', '#39434D', '#8A9AA8', '#C87E4F'], added: '2026-08-06' },
  { id: 'mustard-denim', name: 'Mustard & Denim', colors: ['#F0EAD9', '#D9A420', '#3E5C76', '#1D2D44'], added: '2026-08-06' },
  { id: 'ultramarine-chalk', name: 'Ultramarine & Chalk', colors: ['#FAFAFF', '#C7D1FF', '#3D5AF1', '#0B1C8C'], added: '2026-08-06' },
  { id: 'sherbet-shelf', name: 'Sherbet Shelf', colors: ['#FDF3F5', '#FBD9C6', '#CFE9C8', '#B7D4EC'], added: '2026-08-06' },
  { id: 'blush-plum', name: 'Blush Plum', colors: ['#F7E7EC', '#DCA9BE', '#8E4A6B', '#3A1B2B'], added: '2026-08-06' },
  { id: 'steel-amber', name: 'Steel & Amber', colors: ['#F4F5F7', '#C3C9D1', '#5A6472', '#F0A202'], added: '2026-08-06' },
  { id: 'lagoon-shallows', name: 'Lagoon Shallows', colors: ['#04353F', '#0A6E78', '#31B7A9', '#CFF3EC'], added: '2026-08-06' },
  { id: 'prussian-peach', name: 'Prussian & Peach', colors: ['#0B2A45', '#1F4E79', '#F2A488', '#FDEDE4'], added: '2026-08-06' },
  { id: 'violet-lime', name: 'Violet & Lime', colors: ['#1A0B2E', '#4B1F9E', '#8B5CF6', '#C9F24D'], added: '2026-08-06' },
  { id: 'chilli-cocoa', name: 'Chilli & Cocoa', colors: ['#2A1A16', '#5E332A', '#C24A2B', '#EFC7A5'], added: '2026-08-06' },
  { id: 'highlighter-pop', name: 'Highlighter Pop', colors: ['#FFFFFF', '#111111', '#FFE600', '#00E0B8'], added: '2026-08-06' },
]
