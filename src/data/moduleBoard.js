...
export const MODULE_BOARD = [
  ...
  {
    id: 'ui-auto-builder',
    name: 'Brand Starter (beta)',
    area: 'AI',
    status: 'live',
    health: 'watch',
    summary: 'Live at /create/auto-builder and listed in the AI Studio menu. The next step recorded here — "AI mode deferred to stay under Vercel 12-function limit" — is done: it is a task inside the consolidated /api/ai route, so it cost no function. The dormant client-side alpha it replaced is deleted. Health stays `watch` because the allowance is deliberately small while the per-generation provider cost is measured.',
    recentChanges: [
      'Real generation via /api/ai task brand-starter, OpenRouter primary with Gemini fallback (BS-01)',
      'Palette, font pairing and type scale hand off into the Palette Builder, Font Pair and Type Scale (BS-02)',
      'Account-metered: 1 per free account for ever, 20 a month on Pro, enforced server-side (BS-03)',
      'Retired the hash-seeded client-side alpha and its fake marketing hero (BS-04)',
    ],
    nextSteps: [
      'Founder to confirm the Pro monthly allowance (PRO_MONTHLY_GENERATIONS)',
      'Watch provider cost per generation before raising either number',
    ],
    updated: '2026-09-06',
  },
  {
