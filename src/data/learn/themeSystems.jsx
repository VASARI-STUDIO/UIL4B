    ...
    <>
      <section id="value-sets">
        ...
        <p>
          ...
          <code>#EFEEE9</code> in the light theme and <code>#0A0A0C</code> in the
      ...
      <section id="inversion">
        ...
        <p>
          ...
          dark ground is <code>#0A0A0C</code>; those two measure 1.05:1 against
...
1 - lin(64/255) = 0.9487    <- what inversion would have to give`}</Formula>
      ...
      <section id="surfaces">
        ...
        <p>
          ...
          five surface levels from <code>#0A0A0C</code> to <code>#28292D</code>,
          and the whole span measures 1.36:1 — adjacent levels are between
          1.04:1 and 1.12:1 apart. Those are differences a reader perceives as
