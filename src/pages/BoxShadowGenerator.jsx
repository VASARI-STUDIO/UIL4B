        ...
        <div className="bsg-controls">
          ...
          <div className="bsg-layers">
            ...
            <div className="bsg-layer-actions">
              <button className="btn-xs" onClick={() => duplicateLayer(activeLayer)} title="Duplicate layer" aria-label="Duplicate layer">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>
              </button>
              {layers.length > 1 && (
                <button className="btn-xs" onClick={() => removeLayer(activeLayer)} title="Remove layer" aria-label="Remove layer">
