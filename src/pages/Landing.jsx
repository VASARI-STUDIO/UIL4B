...
// Bento-grid showcase of the toolkit: asymmetric spans give each category its
// own visual weight instead of a uniform tile wall, hairline borders with an
      ...
      <div className="landing-bento">
        {BENTO.map((t) => (
          ...
          >
            ...
            <span className="landing-bento-label">{t.label}</span>
            <h3 className="landing-bento-title">{t.title}</h3>
            <p className="landing-bento-body">{t.body}</p>
    ...
    <div className="landing">
      <header className="landing-nav" ref={navRef}>
        ...
        <div className="landing-nav-actions">
            ...
            {toolsOpen && (
              <div className="landing-tools-panel" role="menu">
                {CATEGORIES.map(cat => {
                  ...
                  const catTools = TOOLS.filter(tl => tl.category === cat.id && !tl.soon)
          ...
          <button type="button" className="landing-theme" onClick={toggleTheme} aria-label={theme === 'dark' ? 'Switch to light theme' : 'Switch to dark theme'}>
            {theme === 'dark' ? (
