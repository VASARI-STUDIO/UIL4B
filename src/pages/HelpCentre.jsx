...
const faqs = [
  ...
  { q: 'Is UIL4B free to use?', a: 'UIL4B offers a generous free tier with all core tools and limited daily AI generations. For higher limits, quality AI models, and Pro-only features, you can upgrade to UIL4B Pro from $4.99 AUD/month.', tags: ['pricing'] },
