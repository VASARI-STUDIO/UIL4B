...
const faqs = [
  ...
  { q: 'What AI features are available?', a: 'UIL4B includes AI-powered tools like the Alt Text Generator (which creates WCAG-compliant alt text for images) and the AI Image Prompt Generator (structured JSON prompts for Midjourney, DALL-E, etc). AI generation runs on free provider tiers, which are metered across the whole site rather than per person, so allowances are deliberately modest and honest: Free gets 5 generations a day (40 a month) and Pro gets 30 a day (300 a month). Both plans use the same model — Pro buys capacity, not different output. Everything else in UIL4B runs in your browser and is unmetered.', tags: ['tools', 'ai'] },
]
