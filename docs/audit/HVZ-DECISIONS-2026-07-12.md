# UIL4B — Historical HVZ Decisions (2026-07-12)

> **Closed historical record.** Moved intact from the former resolved section of
> `docs/DECISIONS-NEEDED.md` on 2026-07-28. It records the provenance and security
> review for the 2026-07-12 founder decisions; it is not a current backlog.
> Current calls live in [`../DECISIONS-NEEDED.md`](../DECISIONS-NEEDED.md).
